...
- Response contains the seed user's email ("demo@spendwise-ish.com")
...
## Definition of done
- [ ] Logging in as the seed user (demo@spendwise-ish.com / demo123) shows "Demo User" and "demo@spendwise-ish.com" on the profile page — not the hardcoded strings
