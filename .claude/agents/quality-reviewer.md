...
their Spendwise-ish project. Your goal is to teach students to 
...
## Spendwise-ish Architecture Context
...
The Spendwise-ish project has a clean separation that's worth 
learning to respect:
- Routes go in `app.py`
