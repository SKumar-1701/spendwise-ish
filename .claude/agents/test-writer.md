...
def auth_client(client):
    ...
    return client
```
Adapt fixtures to the actual Spendwise-ish API as it exists — do not assume helpers beyond what the task describes.
...
**Update your agent memory** as you write tests for Spendwise-ish features. This builds up institutional knowledge about the test suite across conversations. Write concise notes about what you discover.
