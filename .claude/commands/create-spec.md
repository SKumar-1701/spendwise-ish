---
description: Create a spec file and feature branch for the next Spendwise-ish step
...
Spendwise-ish expense tracker. Always follow the rules in CLAUDE.md.
...
it exists at this stage of the Spendwise-ish roadmap.
